...
void printMinimumSpanningTree(const std::vector<Edge> &mst) {
...
void runTestCases(bool detailedOutput = false) {
    vector<vector<int>> testCases = {
            {4, 5, 0, 1, 2, 0, 2, 3, 1, 2, 1, 1, 3, 4, 2, 2, 3, 2, 2, 4, 3, 3, 4, 5},
            {6, 9, 0, 1, 2, 0, 2, 3, 1, 2, 1, 1, 3, 4, 2, 2, 4, 3, 3, 4, 5, 1, 3, 5, 4, 4, 5, 2},
            {4, 4, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3},
            {6, 9, 0, 1, 1, 0, 2, 5, 1, 3, 3, 1, 4, 6, 2, 3, 4, 2, 4, 2, 3, 5, 1, 3, 5, 4, 4, 5, 2},
            {6, 8, 0, 1, 2, 0, 2, 3, 1, 2, 1, 1, 3, 4, 2, 2, 4, 3, 3, 4, 5, 1, 3, 5, 4, 4, 5, 2}};
    int testNum = 0;
